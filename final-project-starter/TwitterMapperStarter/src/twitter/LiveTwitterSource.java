...
public class LiveTwitterSource extends TwitterSource {
    ...
    private void initializeTwitterStream() {
        ...
        cb.setOAuthConsumerKey("a3ymWAid9RCl9E33kx19B21jY")
                .setOAuthConsumerSecret("p3jKnw5QljVFw8Vt5PiaJeYpzvLRWIehqAZUtidUrk500ixRtB")
                .setOAuthAccessToken("2902688280-JX4J4O7x8m5zSNdJSGJSIYr95UNAoiszCriAi2m")
                .setOAuthAccessTokenSecret("Jn6U1f21e4IZLxhFHvNUjIZxFC4fvhG9aD2Vpj6H7io9K");
