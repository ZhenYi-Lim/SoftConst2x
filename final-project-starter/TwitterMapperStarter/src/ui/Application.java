    ...
    public Application() {
        ...
        map().addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                List<MapMarker> markers = getMarkersCovering(pos,15000);
//                map().setToolTipText(((MapMarkerImage) markers.get(0)).getTweetText());
                MapMarkerImage marker = (MapMarkerImage) markers.get(0);
                Image image = marker.getImage();
                String text = marker.getTweetText();
                Color color = marker.getColor();
                map().addMapRectangle(new MapRectangleImage((Coordinate) pos, (Coordinate) pos, color, image, p, text));
            }
        });
    }
